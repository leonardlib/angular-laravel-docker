...
RUN buildDeps=" \
    ...
    && apt-get update && apt-get install -y libc-client2007e libenchant1c2a libfreetype6 libjpeg62-turbo libmcrypt4 libpq5 libsybdb5 libx11-6 libxpm4 libxslt1.1 libmemcached11 libmemcachedutil2 libgpgme11 snmp bind9-host git nano sudo iproute2 openssh-client procps --no-install-recommends \
...
RUN cp /usr/src/app/dist /var/www/html
#RUN cp /var/www/.htaccess /var/www/html

############################### Setup laravel project
WORKDIR /var/www/
RUN composer install
#RUN php -S 0.0.0.0:80 -t public public/index.php
